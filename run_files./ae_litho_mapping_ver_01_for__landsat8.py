# -*- coding: utf-8 -*-
"""ae_litho_mapping_ver_01_for _landsat8.ipynb
...
# loading the data
import rasterio as rio
data_raster = rio.open('drive/MyDrive/VAE_GeoChem/Wilcannia_Landsat8.tif') # change the datafile name here with file address
