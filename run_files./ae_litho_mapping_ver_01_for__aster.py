# -*- coding: utf-8 -*-
"""ae_litho_mapping_ver_01_for _ASTER.ipynb
...
# loading the data
import rasterio as rio
data_raster = rio.open('drive/MyDrive/VAE_GeoChem/Wilcannia_ASTER.tif') # change the datafile name here with file address
...
# Encoder (input bands)9-9-9-9-9-8-7-6-5
